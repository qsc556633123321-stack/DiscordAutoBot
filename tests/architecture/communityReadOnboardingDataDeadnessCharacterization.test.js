...
assert.equal((runtime.match(/readOnboardingData\(\)/g) || []).length, 0, 'no direct-call syntax remains after deletion');
...
console.log('readOnboardingData is removed; adapters use the onboarding state reader.');
