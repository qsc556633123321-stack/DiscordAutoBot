...
assert.doesNotMatch(source, /RoadmapPublicationMessageLookupAdapter|roadmapLookupPort/);
console.log('Roadmap production lookup adapter is runtime wired through Composition');
