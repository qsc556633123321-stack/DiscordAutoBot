...
assert.equal(factory.includes('getRetainedMessage'), true); assert.equal(fs.readFileSync(path.join(root, 'src/systems/communityConcierge.js'), 'utf8').includes('lookupPort.lookup'), false);
