...
assert.equal(fs.existsSync(path.join(root, 'src/application/community/roadmapPublication/RoadmapPublicationMessageMutationPort.js')), false);
...
console.log('Roadmap production mutation Port, Adapter, and Composition remain absent during preparation');
