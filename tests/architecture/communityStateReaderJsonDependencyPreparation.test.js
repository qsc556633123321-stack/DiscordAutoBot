...
for (const removedPath of ['DATA_DIR', 'ONBOARDING_FILE', "require('node:path')"]) assert.equal(runtime.includes(removedPath), false, `Runtime path ownership must remove ${removedPath}`);
