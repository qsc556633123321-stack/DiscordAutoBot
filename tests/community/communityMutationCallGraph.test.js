...
for (const token of ['getOrCreateRoadmapChannel', 'channel.messages.fetch', 'message.edit', 'channel.send', 'saveOnboarding']) assert.match(roadmap, new RegExp(token.replace(/[.]/g, '\\.')));
