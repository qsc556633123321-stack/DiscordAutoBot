...
} = require('../../../application/community/roadmapPublication/RoadmapPublicationMessageMutationPort');
...
function createRoadmapPublicationMessageMutationAdapter({ resourceSession } = {}) {
...
module.exports = { createRoadmapPublicationMessageMutationAdapter };
