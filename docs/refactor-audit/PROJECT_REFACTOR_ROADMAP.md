...
| MemberGuard | complete | complete | status/evaluation/settings/release complete | JSON settings plus Discord mutation gateways | complete | message/join plus command mutations | complete | Migrated / Wrapper Remaining |
| Audit | complete | n/a | complete | complete | n/a | command | migration | Migrated / Wrapper Remaining |
