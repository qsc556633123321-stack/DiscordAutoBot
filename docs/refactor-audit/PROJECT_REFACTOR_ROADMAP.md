...
| Community | complete discovery | Community About facts and Roadmap schema complete | About and Roadmap queries complete | read-only About and Roadmap gateways complete | About and Roadmap compositions complete | active About/Roadmap presentations; other Community paths remain legacy/compatibility | About/Roadmap vertical-slices plus discovery baseline | Migration In Progress; About and Roadmap Migrated / Thin Wrapper Complete |
