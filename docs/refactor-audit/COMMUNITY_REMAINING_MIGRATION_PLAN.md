...
| 2 | Guide content/status query | Concierge helpers | focused read composition | Exclude `getOrCreate`, publication, roles | content/status/stale record fixtures | Medium; interaction fallback | no mutation path changes |
