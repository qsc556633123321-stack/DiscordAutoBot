...
| Community | `community-about` migrated; grouped and legacy commands otherwise retained | Community About complete; remaining slices not started | Community About facts/query complete | read-only About gateway complete; remaining existing | active legacy and compatibility paths retained | Community About thin wrapper; others mixed | Community About vertical-slice, architecture, discovery baseline | Migration In Progress (Community About: Migrated / Thin Wrapper Complete) |
