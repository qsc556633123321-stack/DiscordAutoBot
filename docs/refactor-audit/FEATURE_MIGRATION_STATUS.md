...
| Community | `community-about`, `community-roadmap`, `help-me-start` migrated; Guide read/render delegated by its compatibility publish consumer; grouped and legacy commands otherwise retained | About, Roadmap, Help-me-start, and Guide read/status queries complete; remaining mutation/orchestration slices not started | About facts, Roadmap schema, Help-me-start recommendation, Guide read model complete | read-only gateways/readers complete for migrated slices; remaining existing | active legacy and compatibility paths retained | About, Roadmap, Help-me-start thin wrappers; Guide payload compatibility delegation; others mixed | About/Roadmap/Help-me-start/Guide vertical-slices, architecture, discovery baseline | Migration In Progress (four read slices; Guide setup mutation retained) |
